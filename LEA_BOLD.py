...
from src.dataset import create_BOLD5000_CLIP_dataset, CLIP_METRIC_dataset
...
class Neural_Encoding_Decoding(Neural_Decoding_Template):
    ...
    def infer(self, ckpt_encoder, ckpt_decoder, num_samples, batch_size, num_step=12, gamma_mode='cosine', seed=666):
        ...
        # dataloader
        train_dataset, test_dataset = create_BOLD5000_CLIP_dataset(path=data_cfg['path'], patch_size=data_cfg['patch_size'], image_size=data_cfg['image_size'],
                ...
                clip_name=model_cfg['clip_name'], clip_ckpt=model_cfg['clip_ckpt'])
...
if __name__ == '__main__':
    ...
    ckpt_encoder = 'checkpoints/BOLD_sbj2/checkpoint.pth' # PATH_to_encoder_ckpt
    ckpt_decoder = 'checkpoints/ImageDecoder_MaskGIT/checkpoint_BOLD.pth' # PATH_to_decoder_ckpt
    args.cfg_file = [
        'configs/fMRI_TransAE_BOLD.yaml', # PATH_to_encoder_cfg
